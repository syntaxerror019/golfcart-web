...
Our addition of a high torque motor to the steering rack changed our approach to the project significantly. It allowed us to explore the possibilities of software controlled steering via code and AI.
...
The following video demonstrates the golf cart steering with the new motor drivers and a joystick:


<div style="position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; max-width: 100%;">
    <iframe style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;" 
            src="https://assets.sunkrobotics.com/static/golfcart.sunkrobotics.com/YOLOModelCamera/steeringdemo.mp4" 
            frameborder="0" 
            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" 
            allowfullscreen>
    </iframe>
